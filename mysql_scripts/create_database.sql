...
-- Schema TPDW
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `TPDW` DEFAULT CHARACTER SET utf8 ;
USE `TPDW` ;

-- -----------------------------------------------------
-- Table `TPDW`.`DimTempo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `TPDW`.`DimTempo` (
...
-- -----------------------------------------------------
-- Table `TPDW`.`DimLocalizacao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `TPDW`.`DimLocalizacao` (
...
-- -----------------------------------------------------
-- Table `TPDW`.`DimEclipse`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `TPDW`.`DimEclipse` (
...
-- -----------------------------------------------------
-- Table `TPDW`.`FatoFelicidade`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `TPDW`.`FatoFelicidade` (
  `idTempo` INT NOT NULL,
  `idLocalizacao` INT NOT NULL,
  `idEclipse` INT NOT NULL,
  ...
  CONSTRAINT `fk_Fato_DimTempo`
    FOREIGN KEY (`idTempo`)
    REFERENCES `TPDW`.`DimTempo` (`idTempo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Fato_DimLocalizacao1`
    FOREIGN KEY (`idLocalizacao`)
    REFERENCES `TPDW`.`DimLocalizacao` (`idLocalizacao`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Fato_DimEclipse1`
    FOREIGN KEY (`idEclipse`)
    REFERENCES `TPDW`.`DimEclipse` (`idEclipse`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
